    ...
    <div className="flex-grow flex items-center justify-between px-6 bg-[#0e1626]/40">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative group">
          <button className="flex items-center gap-2.5 p-0.5 rounded-full hover:bg-slate-800/65 cursor-pointer transition-all duration-200 focus:outline-none">
          ...
          {/* Profile Hover Menu */}
          <div className="absolute right-0 mt-2 w-48 bg-[#0e1626] border border-slate-850 rounded-xl shadow-xl py-2 opacity-0 translate-y-2 pointer-events-none group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto transition-all duration-200 z-50">
            ...
            <button className="w-full text-left px-4 py-2 text-xs text-slate-400 hover:bg-[#16223f]/60 hover:text-white cursor-pointer transition-colors duration-150">
            ...
            <div className="border-t border-slate-800 mt-1.5 pt-1.5">
              <button className="w-full text-left px-4 py-2 text-xs text-red-400 hover:bg-red-950/20 cursor-pointer transition-colors duration-150 font-medium">
                Sair do Systema
              </button>
            </div>
          </div>
